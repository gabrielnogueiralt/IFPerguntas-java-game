...
public class JanelaRanking extends JFrame {
	...
	public JanelaRanking() {
		...
		voltarLabel.setHorizontalAlignment(SwingConstants.CENTER);
		voltarLabel.setIcon(new ImageIcon(ClasseDeCaminhos.getCaminhoBotaoFechar()));
//		voltarLabel.setIcon(new ImageIcon("C:\\DIEGO\\workspace\\JogoPerguntas\\Arquivos\\Telas\\Fechar.png"));
		
		contentPane.add(voltarLabel, BorderLayout.SOUTH);
	}
